...
struct BidirectionalAccelerators {
  BidirectionalAccelerators(units::Acceleration acceleration, units::Velocity max_velocity_)
      : positive(acceleration, max_velocity_),
        negative(-acceleration, -max_velocity_) {}
